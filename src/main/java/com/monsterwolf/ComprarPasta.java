...
import static com.monsterwolf.Loja.pasta;
import javax.swing.JOptionPane;




public class ComprarPasta extends javax.swing.JFrame {
    public ComprarPasta() {
        initComponents();
    }
            ...
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("https://raw.githubusercontent.com/alex-custodio/projeto-final-poo/main/src/main/java/com/monsterwolf/pagamentos/pasta-pix.png")
                    );
    ...
    private void confirmarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButtonActionPerformed
        try{
            ...
            pasta.setQuantidade(quantidade);
            vendas.inserirVenda(pasta);
            Loja loja = new Loja();
            loja.setVisible(true);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComprarPasta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComprarPasta().setVisible(true);
            }
        });
    }
